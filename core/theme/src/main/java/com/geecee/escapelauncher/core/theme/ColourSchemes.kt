...
val darkSchemeEscapeTheme = darkColorScheme(
    primary = escapeThemePrimaryDark,
    onPrimary = escapeThemeOnPrimaryDark,
    primaryContainer = escapeThemePrimaryContainerDark,
    onPrimaryContainer = escapeThemeOnPrimaryContainerDark,
    secondary = escapeThemeSecondaryDark,
    onSecondary = escapeThemeOnSecondaryDark,
    secondaryContainer = escapeThemeSecondaryContainerDark,
    onSecondaryContainer = escapeThemeOnSecondaryContainerDark,
    tertiary = escapeThemeTertiaryDark,
    onTertiary = escapeThemeOnTertiaryDark,
    tertiaryContainer = escapeThemeTertiaryContainerDark,
    onTertiaryContainer = escapeThemeOnTertiaryContainerDark,
    error = escapeThemeErrorDark,
    onError = escapeThemeOnErrorDark,
    errorContainer = escapeThemeErrorContainerDark,
    onErrorContainer = escapeThemeOnErrorContainerDark,
    background = escapeThemeBackgroundDark,
    onBackground = escapeThemeOnBackgroundDark,
    surface = escapeThemeSurfaceDark,
    onSurface = escapeThemeOnSurfaceDark,
    surfaceVariant = escapeThemeSurfaceVariantDark,
    onSurfaceVariant = escapeThemeOnSurfaceVariantDark,
    outline = escapeThemeOutlineDark,
    outlineVariant = escapeThemeOutlineVariantDark,
    scrim = escapeThemeScrimDark,
    inverseSurface = escapeThemeInverseSurfaceDark,
    inverseOnSurface = escapeThemeInverseOnSurfaceDark,
    inversePrimary = escapeThemeInversePrimaryDark,
    surfaceDim = escapeThemeSurfaceDimDark,
    surfaceBright = escapeThemeSurfaceBrightDark,
    surfaceContainerLowest = escapeThemeSurfaceContainerLowestDark,
    surfaceContainerLow = escapeThemeSurfaceContainerLowDark,
    surfaceContainer = escapeThemeSurfaceContainerDark,
    surfaceContainerHigh = escapeThemeSurfaceContainerHighDark,
    surfaceContainerHighest = escapeThemeSurfaceContainerHighestDark,
)
