...
class MessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        Log.d("FCM", "Received notification: ${notification?.title} / ${notification?.body}")

        // Get title and message: Check data first, then notification payload, then defaults
        val title = data["title"] ?: notification?.title ?: "Escape Launcher Update"
        val message = data["message"] ?: notification?.body ?: "New update available!"
